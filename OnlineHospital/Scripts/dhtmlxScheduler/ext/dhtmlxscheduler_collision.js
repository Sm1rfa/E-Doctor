...
return t[s]==i[s]&&t.id!=i.id?!0:!1},e.checkCollision=function(t){var s=[],n=e.config.collision_limit;if(t.rec_type)for(var a=e.getRecDates(t),r=0;r<a.length;r++)for(var d=e.getEvents(a[r].start_date,a[r].end_date),o=0;o<d.length;o++)(d[o].event_pid||d[o].id)!=t.id&&s.push(d[o]);else{s=e.getEvents(t.start_date,t.end_date);for(var l=0;l<s.length;l++)if(s[l].id==t.id){s.splice(l,1);break}}var _=e._get_section_view(),h=e._get_section_property(),c=!0;if(_){for(var u=0,l=0;l<s.length;l++)s[l].id!=t.id&&this._check_sections_collision(s[l],t)&&u++;
u>=n&&(c=!1)}else s.length>=n&&(c=!1);if(!c){var f=!e.callEvent("onEventCollision",[t,s]);return f||(t[h]=i||t[h]),f}return c}}()});